		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px;">
				<form action="joinAction.jsp" method="post">
					<h3 style="text-align: center;">카카오프렌즈와 함께해 주세요!</h3>
					...
					<input type="submit" class="btn btn-primary form-control" value="회원가입" style="background-color: gold; color: black; border: 1px solid gold;">
				</form>
			</div>
		</div>
		<div class="col-lg-4"></div>
